...
export function networkOverview(model: PixelModel, input: number[], labels: readonly string[], selected: boolean, neuron: number, output: number, options: {classColors?:readonly string[];onlyOutput?:number} = {}): string {
