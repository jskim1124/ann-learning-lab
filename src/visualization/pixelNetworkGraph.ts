...
export function pixelNetworkGraphMarkup(model: PixelModel, labels: readonly string[], hiddenValues: number[], probabilities: number[] = []): string {
  ...
  return `<g font-family="sans-serif" font-size="10" fill="#343844">${inputLines}${outputLines}<rect x="12" y="112" width="60" height="76" rx="8" fill="#f4f5f8" stroke="#697383"/><text x="42" y="139" text-anchor="middle" font-weight="800">14×14</text><text x="42" y="156" text-anchor="middle">196 픽셀</text><text x="42" y="173" text-anchor="middle">한 묶음</text>${hiddenNodes}${outputNodes}<text x="42" y="286" text-anchor="middle">입력</text><text x="165" y="286" text-anchor="middle">은닉 뉴런 ${model.hiddenUnits}개${model.hiddenUnits > shown ? ` (앞 ${shown}개)` : ""}</text><text x="276" y="286" text-anchor="middle">출력 ${model.classCount}개</text></g>`;
}
